  ...
  return (
    <div>
      ...
      <div className="mt-6 sm:mt-8 grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        <Link href="/dashboard/listings" className="card p-5 sm:p-6 hover:shadow-md min-h-[44px] flex flex-col">
        ...
        <Link href="/dashboard/claims" className="card p-5 sm:p-6 hover:shadow-md min-h-[44px] flex flex-col">
