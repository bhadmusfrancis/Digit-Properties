  ...
  return (
    <div>
      ...
      <div className="mt-6 space-y-4">
        {list.map((l: { _id: string; title: string; price: number; location?: { city: string; state: string } }) => (
          <Link
            key={l._id}
            href={`/listings/${l._id}`}
          ...
          >
            ...
            <span className="text-primary-600 font-semibold">{formatPrice(l.price)}</span>
          </Link>
        ))}
        {list.length === 0 && (
