...
import { EditListingFormLoader } from '@/components/listings/EditListingFormLoader';
...
export default async function EditListingPage({ params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    // Some chat imports stuffed description markup into address — keep form usable.
    ...
    const editInitial: ListingFormProps['editInitial'] = {
      ...
      images: Array.isArray(listing.images)
        ? listing.images
            .filter((img: { url?: string; public_id?: string }) => img?.url || img?.public_id)
    ...
    throw e instanceof Error ? e : new Error('Failed to load listing editor');
  }
}
