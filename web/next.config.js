...
const nextConfig = {
  ...
  // Listing slug-move and deleted-listing 301s are served dynamically by
  // src/proxy.ts (DB lookup via resolveListingPublicSegment) — exporting them
  // as static routes exceeds Vercel's 2048-route limit.
  async redirects() {
    return [
      {
        source: '/:path*',
