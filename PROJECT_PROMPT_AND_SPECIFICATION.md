...
- **User dashboard:** Profile, My Properties (draft/active/closed), saved searches/alerts, Saved Properties, my claims (status), payment history (boosts, ads), ratings received, settings (notification prefs, social account linking).
